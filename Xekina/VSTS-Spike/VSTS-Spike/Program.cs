...
namespace VSTS_Spike
{
    class Program
    {
        ...
        private static void BuildSpike()
        {
            ...
            var a = buildHttpClient.GetDefinitionAsync("Xekina", 13).SyncResult();
            BuildDefinition newBuildDefinition = CloneBuild(a);
        ...
        private static BuildDefinition CloneBuild(BuildDefinition b)
        {
            ...
            n.Description = "Where does this appear?";
            ...
            n.Name = "Auto-Generated " + DateTime.Now.Ticks.ToString();
